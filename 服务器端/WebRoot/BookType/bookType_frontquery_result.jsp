				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>图书类别id</td><td>类别名称</td><td>可借阅天数</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="bookType_bookTypeId_edit" class="col-md-3 text-right">图书类别id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="bookType_bookTypeId_edit" name="bookType.bookTypeId" class="form-control" placeholder="请输入图书类别id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
