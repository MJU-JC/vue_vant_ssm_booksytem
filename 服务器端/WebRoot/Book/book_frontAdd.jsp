	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="book_hitNum" class="col-md-2 text-right">浏览量:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="book_hitNum" name="book.hitNum" class="form-control" placeholder="请输入浏览量">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="book_bookDesc" class="col-md-2 text-right">图书简介:</label>
				  	 <div class="col-md-8">
							    <textarea name="book.bookDesc" id="book_bookDesc" style="width:100%;height:500px;"></textarea>
					 </div>
				  </div>
				  <div class="form-group">
