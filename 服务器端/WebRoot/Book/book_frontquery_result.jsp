  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="book_hitNum_edit" class="col-md-3 text-right">浏览量:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="book_hitNum_edit" name="book.hitNum" class="form-control" placeholder="请输入浏览量">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="book_bookDesc_edit" class="col-md-3 text-right">图书简介:</label>
		  	 <div class="col-md-9">
			 	<textarea name="book.bookDesc" id="book_bookDesc_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (book, response, status) {
			if (book) {
				...
				$("#book_hitNum_edit").val(book.hitNum);
