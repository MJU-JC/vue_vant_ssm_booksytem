...
<div id="bookAddDiv">
	<form id="bookAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="book_hitNum" name="book.hitNum" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<script name="book.bookDesc" id="book_bookDesc" type="text/plain"   style="width:750px;height:500px;"></script>
			</span>
