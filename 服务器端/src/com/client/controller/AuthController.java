...
public class AuthController {
	...
	public JsonResult sendSMS(String tel) throws Exception { 
	...
	public JsonResult register_weixin(String avatarUrl,String genDer,String nickName,String tel,String jsCode,HttpServletRequest request) throws Exception {
