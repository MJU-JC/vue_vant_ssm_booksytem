...
public class ApiUserInfoController {
	...
	/*ajax方式显示获取用户详细信息*/
	@RequestMapping(value="/self_get",method=RequestMethod.POST)
	public JsonResult getUserInfo(Model model,HttpServletRequest request,HttpServletResponse response) throws Exception {
